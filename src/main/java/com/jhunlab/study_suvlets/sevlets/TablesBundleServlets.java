...
public class TablesBundleServlets  extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 이 안에는 두가지가 같이 들어가 있는 상태 func 호출하면 두가지의 변수가 다 들어와있음
        HashMap<String, String> searchForm = (HashMap<String, String>) bundlesData.get("searchForm");
        // object로 인식해서 무슨 데이터 타입인지 인지를 못하는 상태라 에러  => (HashMap<String, String>)  cast로 해결
        ArrayList<String> tablesListWithString = (ArrayList<String>) bundlesData.get("tablesLostWithString");
        ...
        printWriter.println(" <div class='fs-3'>Tables with Bundle Data</div> ");
